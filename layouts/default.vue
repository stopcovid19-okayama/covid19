...
export default Vue.extend({
  ...
  head(): MetaInfo {
    ...
    return {
      ...
      titleTemplate: `%s | ${this.$t('岡山県')} ${this.$t('新型コロナウイルス感染症')}${this.$t('対策サイト')}`,
      meta: [
        {
          hid: 'author',
          name: 'author',
        ...
        },
        {
          ...
          content: `${this.$t('{date} 更新', {
            date: convertDateToSimpleFormat(Data.date)
          })}: ${this.$tc(
        ...
        },
        {
          hid: 'og:url',
          property: 'og:url',
          content: `https://okayama.stopcovid19.jp${this.$route.path}`
        },
        ogLocale,
        {
          hid: 'og:title',
