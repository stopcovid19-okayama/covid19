<template>
  <div class="About">
    ...
    <static-card>
      ...
      {{
        $t(
          '岡山県から公開された、エビデンスのある情報と客観的な数値をわかりやすく伝えることで、岡山県にお住まいの方や、岡山県内に拠点を持つ企業の方、岡山県を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。'
        )
      }}
    </static-card>
    <StaticCard>
      <h3>{{ $t('データについて') }}</h3>
      <p>
        {{ $t('当サイトは、1日に最大6回、データを更新しています。') }}<br />
        {{
          $t(
            '岡山県のデータが更新され次第の反映となりますので予めご了承ください。'
          )
        }}<br />
        {{
          $t(
            'エビデンスのある情報を岡山県にお住まいの方、岡山県に訪れる方に迅速かつ正確でわかりやすく伝えるためにご協力をお願いいたします。'
          )
        }}
      </p>
      <br />
